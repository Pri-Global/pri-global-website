export const industries = [
  {
    ...
    highlights: [
      "Core banking & insurance platform modernisation",
      "Regulatory compliance & risk automation",
  ...
  },
  {
    ...
    highlights: [
      "ERP & MES implementation and modernisation",
      "IoT, edge computing & predictive maintenance",
  ...
  },
  {
    ...
    highlights: [
      "Trade promotion management & analytics",
      "Demand forecasting & inventory optimisation",
      "Consumer data platforms & personalisation",
    ],
  },
  {
    id: "healthcare",
  ...
  },
  {
    ...
    highlights: [
      "Government cloud migration & FedRAMP compliance",
      "Digital identity & access management",
      "Open data platforms & citizen portals",
    ],
  },
  {
    id: "retail",
    ...
    highlights: [
      ...
      "Real-time inventory & fulfilment management",
    ],
  },
];
