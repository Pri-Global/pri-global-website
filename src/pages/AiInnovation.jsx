...
export default function AiInnovation() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  Explore PRI AI Pods™ <ArrowRight size={16} />
                </Link>
                <a
                  href={BOOKING_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-white/25 text-white font-medium text-sm hover:bg-white/10 transition-colors"
                >
            ...
            <div className="hidden lg:block">
              <div className="flex items-center justify-center h-[240px] lg:h-[280px]">
                <img
                  src={pr1smLogo}
                  alt="PR1SM.AI"
      ...
      <section className="py-10 md:py-14 bg-[var(--bg-secondary)]">
        <div className="site-container">
          ...
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-10">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-royal/10 border border-royal/20 text-xs font-bold tracking-widest uppercase text-royal mb-4">
              Your AI Intelligence Layer
            </span>
            <div className="font-heading text-4xl sm:text-5xl font-extrabold text-royal dark:text-royaldark mb-3 tracking-tight">
              PR1SM.AI
            </div>
            <h2 className="font-heading text-xl md:text-2xl font-bold text-[var(--text-primary)] leading-snug mb-3">
            ...
            <p className="text-[var(--text-secondary)] leading-relaxed text-base md:text-lg">
              Talk to your data in plain English. PR1SM.AI turns fragmented systems into instant
              decisions — securely, without rip-and-replace.
            </p>
          </div>

          {/* 5 pillars */}
          <div ref={prismRef} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 md:mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5 mb-8 md:mb-10">
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 md:p-7">
          ...
          {/* How PR1SM Delivers */}
          <div ref={deliveryRef} className="mb-8 md:mb-10">
            <h3 className="font-heading text-xl md:text-2xl font-bold text-[var(--text-primary)] text-center mb-5">How PR1SM Delivers</h3>
          ...
          {/* Who PR1SM Fits */}
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 md:p-7 mb-8 md:mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-royal mb-3 block">Who PR1SM Fits</span>
          ...
          {/* Impact grid */}
          <div ref={impactRef} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 md:mb-10">
          ...
          <div className="bg-navy rounded-2xl p-6 md:p-8 text-center">
            ...
            <p className="text-white/60 mb-5 text-base md:text-lg">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-royaldark text-white font-semibold text-sm hover:bg-royaldark/80 transition-colors mb-3"
            >
              See PR1SM in Action <ExternalLink size={16} />
            </a>
            <p className="text-sm mb-1">
              <Link to="/roi-calculator" className="text-white/50 hover:text-royaldark transition-colors underline-offset-2 hover:underline">
                Estimate your ROI with our calculator →
              </Link>
            </p>
      ...
      <section className="py-10 md:py-14 bg-[var(--bg-secondary)]">
        <div className="site-container">
          <SectionHeading
            ...
            className="mb-8"
          />
          <div ref={servicesRef} className="grid md:grid-cols-2 gap-4 md:gap-5">
            {aiServices.map((s, i) => {
              const Icon = s.icon;
              return (
                <div
      ...
      {/* ── SECTION 5: CTA ───────────────────────────────────────────────────── */}
      <section className="py-14 md:py-16 bg-navy relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
