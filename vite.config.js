...
import candidateRegister from './api/_candidate/register.js'
import candidateLogin from './api/_candidate/login.js'
import candidateProfile from './api/_candidate/profile.js'
import candidateApplications from './api/_candidate/applications.js'
import candidateApply from './api/_candidate/apply.js'
import candidateDashboard from './api/_candidate/dashboard.js'
import employeeMicrosoftCallback from './api/_employee/auth/microsoft/callback.js'
import employeeMicrosoftAuth from './api/_employee/auth/microsoft.js'
import employeeRipplingAuth from './api/_employee/auth/rippling.js'
import employeeRipplingConnect from './api/_employee/rippling/connect.js'
import employeeRipplingCallback from './api/_employee/rippling/callback.js'
